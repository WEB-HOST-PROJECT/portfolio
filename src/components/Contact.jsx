        ...
        <section id="contact" className="py-20 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row">
                    <div className="md:w-1/2 p-8 bg-blue-600 text-white flex flex-col justify-between">
                        <div>
                        ...
                        <div className="flex space-x-4 mt-8">
                            <a href="https://github.com/nitinyadav08i" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition duration-300 text-white font-bold" title="GitHub">
